...
function choosePostAudit() {
  contentclass.value = 'postaudit'
}
function chooseUserComplain() {
  contentclass.value = 'usercomplain'
}
function choosePostComplain() {
  contentclass.value = 'postcomplain'
}
